  ...
  return (
    <main className="flex-1 pb-8">
      ...
      {/* 実データレビュー：知恵袋に「サークルに入ったら想像と違い後悔した」等の実例が
          ...
          入会費用についても、知恵袋に「合宿費が1人4万円で愕然とした」等の実例があったが、
          各団体が独自に決める金額を本アプリが実額として扱うと同じ真正性リスクを負うため、
          団体名・金額を一切扱わない一般的な注意喚起の一文のみ追加した（サイクル208）。 */}
      <div className="px-4 mt-3">
        <Card>
          <p className="text-xs font-medium mb-1">サークル・部活動を探す</p>
          <p className="text-xs text-gray-600 leading-relaxed">
            入ってみないと分からない雰囲気もありますが、まずは一覧で探してみましょう。部費・道具代・合宿費等は団体によって差が大きいため、入会前に必ず確認しましょう。
          </p>
          <div className="flex flex-col gap-1 mt-2">
            <a
